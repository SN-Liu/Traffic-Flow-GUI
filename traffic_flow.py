        ...
        with open(traffic_name2,'r') as file2:
            ...
            for line2 in lines2:
                ...
                if c > 4:
                    ...
                    if line2.startswith('Traffic.'+ str( traffic_number1 +int( (c-5)/61)) + '.Name'):
                        line2 = line2.replace('T' + str(int((c-5)/61)), 'T' + str( traffic_number1 +int( (c-5)/61)))
                    if line2.startswith('Traffic.'+ str( traffic_number1 +int( (c-5)/61)) + '.Info'):
                        line2 = line2.replace('UNNAMED Object ' + str(int((c-5)/61)), 'UNNAMED Object ' + str( traffic_number1 +int( (c-5)/61)))
...
def traffic_write(testrun_name,new_path):
